...
#define PARAMETRIDEFAULT "./Appfixed.exe 11001"
void usage(void) 
{  printf ( "usage:  ./Appfixed.exe REMOTEPORT\n"
	...
	for(;;)
	{
		...
		if( FD_ISSET(LBfixedfd,&rdset) )
		{
			...
			if(primoricevuto==0) {
				...
				idlastrecv=idletto;
				numricevuti=1;
				/* faccio partire il pthread scheduler per attivare la generazione di pacchetti */
